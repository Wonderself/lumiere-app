    ...
    <div className="min-h-screen">
      ...
      <section className="relative pt-24 pb-16 px-4 overflow-hidden bg-gradient-to-b from-white/[0.02] to-transparent">
        ...
        <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
          <div className="absolute top-20 left-1/4 w-96 h-96 bg-[#D4AF37]/[0.05] rounded-full blur-[120px]" />
          <div className="absolute top-10 right-1/3 w-72 h-72 bg-[#D4AF37]/[0.06] rounded-full blur-[100px]" />
          {/* Gold particles */}
      ...
      <div className="relative px-4 pb-16">
        ...
        <div className="container mx-auto max-w-4xl">
            ...
            <>
              ...
              {top3.length > 0 && (
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-16 sm:items-end">
                  ...
                  <div className="flex flex-col items-center p-6 sm:p-5 rounded-2xl sm:rounded-3xl border border-[#D4AF37]/30 bg-[#D4AF37]/[0.04] sm:order-2 hover-lift transition-all duration-500">
                    <div className="mb-3">
          ...
          {/* CTA */}
          <div className="mt-16 text-center p-8 rounded-2xl sm:rounded-3xl border border-[#D4AF37]/20 bg-[#D4AF37]/[0.03] relative overflow-hidden transition-all duration-500">
            <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
            ...
            <div className="relative">
              ...
              <a
                href="/register"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-[#D4AF37] text-white font-semibold hover:bg-[#C4A030] transition-colors"
              >
