    ...
    <div className="min-h-screen py-16 sm:py-20 px-4">
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-6 text-sm">
          <Link href="/legal/privacy" className="text-[#D4AF37] underline underline-offset-4 hover:text-[#F0D060] transition-colors duration-300">
            Politique de Confidentialité
          </Link>
          <span className="text-white/10">|</span>
          <Link href="/legal/cookies" className="text-[#D4AF37] underline underline-offset-4 hover:text-[#F0D060] transition-colors duration-300">
            Politique Cookies
          </Link>
        </div>
      </div>
