  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto max-w-5xl relative z-10 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3 mt-8 sm:mt-10">
            <Link
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-gray-100 border border-gray-200 text-sm font-medium text-gray-700 hover:border-[#E50914]/30 hover:text-[#E50914] hover:bg-[#E50914]/[0.04] transition-all duration-300 min-h-[44px]"
            >
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-[#E50914] text-white text-sm font-semibold hover:bg-[#C4A030] transition-all duration-300 shadow-sm min-h-[44px]"
            >
      ...
      <div className="container mx-auto max-w-5xl px-6 sm:px-10 md:px-16 lg:px-20 pb-20 sm:pb-24 space-y-12 sm:space-y-16">
              ...
              {contests.map((contest) => {
                ...
                return (
                  <Link key={contest.id} href={`/community/contests/${contest.id}`}>
                    <Card variant={contest.status === 'VOTING' ? 'gold' : 'default'} className="h-full group cursor-pointer border-gray-100 bg-white shadow-sm hover:shadow-lg hover:shadow-[#E50914]/5 hover:-translate-y-[1px] transition-all duration-500">
            ...
            <div className="space-y-3">
              {votingScenarios.map((scenario, idx) => (
                <Link key={scenario.id} href={`/community/scenarios/${scenario.id}`}>
                  <div className="group flex items-center gap-3 sm:gap-4 p-4 sm:p-5 sm:rounded-2xl rounded-xl border border-gray-100 bg-white hover:border-[#E50914]/30 hover:shadow-lg hover:shadow-[#E50914]/5 hover:-translate-y-[1px] transition-all duration-500 min-h-[56px] shadow-sm backdrop-blur-sm">
                    ...
                    <div className="flex-1 min-w-0">
                      <h4 className="font-semibold text-sm text-gray-900 group-hover:text-[#E50914] transition-colors duration-300 truncate">
                        {scenario.title}
                      </h4>
                ...
                <Link key={w.id} href={`/community/scenarios/${w.id}`}>
                  <Card variant="gold" className="h-full group cursor-pointer border-[#E50914]/20 bg-[#E50914]/[0.03] hover:shadow-lg hover:shadow-[#E50914]/5 hover:-translate-y-[1px] transition-all duration-500">
                    <CardContent className="p-5">
                      ...
                      <h4 className="font-semibold text-sm text-gray-900 group-hover:text-[#E50914] transition-colors duration-300 mb-1">
                        {w.title}
                      </h4>
        ...
        {/* CTA */}
        <div className="text-center p-6 sm:p-10 sm:rounded-3xl rounded-2xl border border-[#E50914]/20 bg-gradient-to-br from-[#E50914]/[0.04] to-white relative overflow-hidden shadow-sm">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3">
            <Link
              href="/community/scenarios"
              className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-full bg-[#E50914] text-white font-semibold hover:bg-[#C4A030] transition-all duration-300 shadow-sm min-h-[44px]"
            >
              <PenTool className="h-4 w-4" />
