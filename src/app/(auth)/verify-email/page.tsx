...
export const metadata: Metadata = { title: 'Verification Email — Lumiere' }
...
export default async function VerifyEmailPage({
  ...
  if (!token) {
    return (
      <div className="text-center space-y-5 sm:rounded-3xl rounded-2xl border border-white/[0.08] bg-white/[0.03] backdrop-blur-sm p-10 sm:p-12 shadow-2xl shadow-black/20">
        ...
        <Link
          href="/login"
          className="inline-block mt-4 px-6 py-3 rounded-xl bg-[#D4AF37] text-black font-semibold hover:bg-[#F0D060] transition-all"
        >
          Se connecter
        </Link>
      </div>
  ...
  return (
    <div className="text-center space-y-5 sm:rounded-3xl rounded-2xl border border-red-500/20 bg-red-500/[0.05] backdrop-blur-sm p-10 sm:p-12 shadow-2xl shadow-red-500/5">
