    ...
    <div className="relative overflow-hidden bg-white text-gray-900">
      ...
      <section className="relative min-h-[100svh] flex flex-col items-center justify-center text-center px-4 pt-24 pb-16 overflow-hidden bg-gradient-to-b from-white via-gray-50/50 to-white">
        ...
        <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
          ...
          {/* Corner accents */}
          <div className="absolute top-16 left-8 w-24 h-24 border-l border-t border-[#D4AF37]/15 rounded-tl-3xl" />
          <div className="absolute top-16 right-8 w-24 h-24 border-r border-t border-[#D4AF37]/15 rounded-tr-3xl" />
          <div className="absolute bottom-16 left-8 w-24 h-24 border-l border-b border-[#D4AF37]/15 rounded-bl-3xl" />
          <div className="absolute bottom-16 right-8 w-24 h-24 border-r border-b border-[#D4AF37]/15 rounded-br-3xl" />
        ...
        {/* Badge */}
        <div className="relative inline-flex items-center gap-2 rounded-full border border-[#D4AF37]/20 bg-[#D4AF37]/10 px-5 py-2 text-sm text-[#D4AF37] mb-4">
        ...
        <div className="relative flex flex-col sm:flex-row gap-4 mb-20 w-full sm:w-auto px-4 sm:px-0">
          <Link href="/tokenization" className="w-full sm:w-auto">
            <Button size="xl" className="group text-base sm:text-lg px-8 sm:px-12 w-full sm:w-auto bg-[#D4AF37] text-white hover:bg-[#C4A030] rounded-full">
            ...
            {howItWorksSteps.map((step, i) => (
              <div key={step.number} className="relative group">
                ...
                {i < howItWorksSteps.length - 1 && (
                  <div className="hidden lg:block absolute top-12 left-[calc(50%+40px)] w-[calc(100%-40px)] h-px bg-gradient-to-r from-[#D4AF37]/30 to-transparent z-0" />
                )}
                <div className="relative rounded-2xl border border-gray-100 bg-white p-6 sm:p-8 hover:border-[#D4AF37]/30 hover:shadow-md transition-all duration-500 h-full shadow-sm">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {modules.map((mod) => (
              <Link key={mod.title} href={mod.href} className={`group ${mod.featured ? 'sm:col-span-2 lg:col-span-1' : ''}`}>
                <div
                  className={`relative rounded-2xl border bg-white p-6 sm:p-8 h-full transition-all duration-500 hover:scale-[1.02] hover:shadow-md shadow-sm ${mod.featured ? 'ring-1 ring-[#D4AF37]/20 shadow-md' : ''}`}
                  style={{
            ...
            <div className="relative rounded-2xl border border-[#D4AF37]/20 bg-[#D4AF37]/[0.04] p-6 sm:p-8 flex flex-col items-center justify-center text-center">
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[#D4AF37]/15 border border-[#D4AF37]/20 mb-5">
              ...
              <Link href="/tokenization">
                <Button variant="outline" size="sm" className="group border-[#D4AF37]/30 text-[#D4AF37] hover:bg-[#D4AF37]/10 rounded-full">
                  Devenez Producteur
        ...
        <div className="container mx-auto max-w-6xl relative">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              ...
              <div className="mt-10">
                <Link href="/register">
                  <Button size="lg" className="group bg-[#D4AF37] text-white hover:bg-[#C4A030] rounded-full">
            ...
            <div className="relative">
              ...
              <div className="relative rounded-3xl border border-gray-200 bg-white shadow-lg p-8 sm:p-10">
                ...
                <div className="relative rounded-2xl overflow-hidden bg-gradient-to-br from-gray-100 via-gray-50 to-gray-200 aspect-video mb-6 border border-gray-200">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="relative">
                      <div className="w-20 h-20 sm:w-28 sm:h-28 rounded-full border-2 border-dashed border-[#D4AF37]/40 flex items-center justify-center bg-white/50">
              ...
              <div className="absolute -top-6 -left-6 w-12 h-12 rounded-xl bg-gradient-to-br from-purple-100 to-[#D4AF37]/10 border border-gray-200 flex items-center justify-center shadow-sm">
                <Heart className="h-5 w-5 text-purple-400/60" />
              </div>
              <div className="absolute -bottom-4 -right-4 w-10 h-10 rounded-lg bg-gradient-to-br from-[#D4AF37]/10 to-purple-100 border border-gray-200 flex items-center justify-center shadow-sm">
      ...
      <section className="py-24 sm:py-32 px-4 bg-white">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-14">
            ...
            <Link
              href="/films"
              className="hidden sm:flex items-center gap-2 text-[#D4AF37] hover:text-[#C4A030] transition-colors text-sm font-medium shrink-0"
            >
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {films.map((film) => (
                <Link key={film.id} href={`/films/${film.slug}`}>
                  <div className="group rounded-2xl border border-gray-100 bg-white overflow-hidden hover:border-[#D4AF37]/30 hover:shadow-md transition-all duration-500 h-full shadow-sm">
                    {/* Poster */}
                    <div className="relative h-48 sm:h-52 bg-gradient-to-br from-[#D4AF37]/[0.06] to-gray-100 overflow-hidden">
                      {film.coverImageUrl ? (
                        <img
          ...
          <div className="sm:hidden mt-8 text-center">
            <Link
              href="/films"
              className="inline-flex items-center gap-2 text-[#D4AF37] hover:text-[#C4A030] transition-colors text-sm font-medium"
            >
              Voir tous les films <ChevronRight className="h-4 w-4" />
            </Link>
          </div>
            ...
            {testimonials.map((t) => (
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#D4AF37]/20 to-purple-200/40 border border-gray-200 flex items-center justify-center text-sm font-bold text-gray-600">
                    {t.name.charAt(0)}
                  </div>
                  <div>
      ...
      <section className="py-24 sm:py-32 px-4 bg-white">
        <div className="container mx-auto max-w-4xl">
          <div className="relative rounded-3xl border border-[#D4AF37]/20 bg-gradient-to-br from-[#D4AF37]/[0.04] via-white to-purple-50/30 p-8 sm:p-12 lg:p-16 overflow-hidden shadow-sm">
            ...
            <div className="relative grid md:grid-cols-2 gap-10 items-center">
              {/* Left text */}
              <div>
                <div className="inline-flex items-center gap-2 rounded-full border border-[#D4AF37]/20 bg-[#D4AF37]/10 px-4 py-1.5 text-sm text-[#D4AF37] mb-6">
              ...
              <div className="flex flex-col gap-4">
                {/* Reward card 1 */}
                <div className="rounded-xl border border-[#D4AF37]/15 bg-white p-5 flex items-center gap-4 shadow-sm">
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-[#D4AF37]/10 border border-[#D4AF37]/20">
            ...
            {plans.map((plan) => (
              <div
                ...
                className={`relative rounded-2xl border p-6 sm:p-7 flex flex-col h-full transition-all duration-300 ${
                  plan.featured
                    ? 'border-[#D4AF37]/40 bg-[#D4AF37]/[0.04] scale-[1.02] shadow-lg'
                    : 'border-gray-100 bg-white hover:border-gray-200 shadow-sm'
                }`}
              >
                {plan.featured && (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 text-[10px] uppercase tracking-widest font-bold bg-gradient-to-r from-[#D4AF37] to-[#F0D060] text-white px-4 py-1 rounded-full">
                    Populaire
                  </div>
                )}
                {/* Plan name */}
                ...
                <Link href="/subscription" className="w-full">
                  <Button
                    className={`w-full rounded-full ${plan.featured ? 'bg-[#D4AF37] text-white hover:bg-[#C4A030]' : 'bg-gray-100 text-gray-700 hover:bg-gray-200 border border-gray-200'}`}
                    size="lg"
                  >
                    {plan.cta}
                  </Button>
      ...
      <section className="relative py-32 sm:py-40 px-4 overflow-hidden bg-white">
        {/* Soft gradient bg */}
        <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
          <div className="absolute inset-0 bg-gradient-to-b from-transparent via-[#D4AF37]/[0.04] to-[#D4AF37]/[0.02]" />
        ...
        <div className="relative container mx-auto max-w-3xl text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8 px-4 sm:px-0">
            <Link href="/tokenization" className="w-full sm:w-auto">
              <Button size="xl" className="group text-base sm:text-lg px-10 sm:px-14 w-full sm:w-auto bg-[#D4AF37] text-white hover:bg-[#C4A030] rounded-full">
                <Coins className="h-5 w-5" />
                Devenez Producteur
                <ArrowRight className="h-5 w-5 group-hover:translate-x-1 transition-transform" />
              </Button>
