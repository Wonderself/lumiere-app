...
const GENRE_POSTERS: Record<string, string[]> = {
  ...
  Documentary: [
    ...
    'https://images.unsplash.com/photo-1518173946687-a1e0e2a3eebc?auto=format&fit=crop&w=400&h=600&q=80',
    'https://images.unsplash.com/photo-1504700610630-ac6edd918cc0?auto=format&fit=crop&w=400&h=600&q=80',
