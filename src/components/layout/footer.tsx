...
export function Footer() {
  return (
    <footer className="relative border-t border-white/[0.04] bg-[#060606] pt-28 md:pt-32 pb-16 md:pb-20 mt-32">
      {/* Subtle top glow */}
      ...
      <div className="mx-auto max-w-[1400px] px-8 md:px-16 lg:px-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-16 lg:gap-16">
          {/* Brand — 5 cols */}
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <ul className="space-y-4">
              ...
              <li><Link href="/community" className="group flex items-center gap-2 text-[13px] text-white/25 hover:text-[#E50914] transition-colors"><Users className="h-3.5 w-3.5 opacity-40 group-hover:opacity-100 transition-opacity" />Communaute</Link></li>
              <li><Link href="/leaderboard" className="group flex items-center gap-2 text-[13px] text-white/25 hover:text-[#E50914] transition-colors"><BarChart3 className="h-3.5 w-3.5 opacity-40 group-hover:opacity-100 transition-opacity" />Classement</Link></li>
              ...
              <li><Link href="/pricing" className="group flex items-center gap-2 text-[13px] text-white/25 hover:text-[#E50914] transition-colors"><Tag className="h-3.5 w-3.5 opacity-40 group-hover:opacity-100 transition-opacity" />Tarifs</Link></li>
              <li><Link href="/developers" className="group flex items-center gap-2 text-[13px] text-white/25 hover:text-[#E50914] transition-colors"><Code2 className="h-3.5 w-3.5 opacity-40 group-hover:opacity-100 transition-opacity" />API Developpeurs</Link></li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <ul className="space-y-4">
              <li><Link href="/register" className="group flex items-center gap-2 text-[13px] text-white/25 hover:text-[#E50914] transition-colors"><Users className="h-3.5 w-3.5 opacity-40 group-hover:opacity-100 transition-opacity" />Creer un compte</Link></li>
              <li><Link href="/register?role=SCREENWRITER" className="group flex items-center gap-2 text-[13px] text-white/25 hover:text-[#E50914] transition-colors"><Pen className="h-3.5 w-3.5 opacity-40 group-hover:opacity-100 transition-opacity" />Soumettre un scenario</Link></li>
              <li><Link href="/tasks" className="group flex items-center gap-2 text-[13px] text-white/25 hover:text-[#E50914] transition-colors"><Award className="h-3.5 w-3.5 opacity-40 group-hover:opacity-100 transition-opacity" />Taches disponibles</Link></li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <ul className="space-y-4">
              ...
              <li><Link href="/invest" className="text-[13px] text-white/25 hover:text-[#E50914] transition-colors font-medium">Investisseurs</Link></li>
            </ul>
          </div>
        </div>
