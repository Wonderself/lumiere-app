...
export function Footer() {
  return (
    <footer className="relative border-t border-white/[0.04] bg-[#060606] pt-20 pb-12 mt-24">
      {/* Subtle top glow */}
      ...
      <div className="mx-auto max-w-[1400px] px-8 md:px-16 lg:px-20">
        ...
        {/* Bottom bar */}
        <div className="mt-16 pt-10 border-t border-white/[0.04] flex flex-col md:flex-row items-center justify-between gap-5">
