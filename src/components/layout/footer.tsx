...
export function Footer() {
  return (
    <footer className="relative border-t border-white/[0.04] bg-[#060606] pt-24 pb-14 mt-28">
      {/* Subtle top glow */}
      ...
      <div className="mx-auto max-w-[1400px] px-8 md:px-16 lg:px-20">
        ...
        {/* Bottom bar */}
        <div className="mt-20 pt-12 border-t border-white/[0.04] flex flex-col md:flex-row items-center justify-between gap-6">
