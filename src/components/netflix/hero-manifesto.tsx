      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 md:px-12 text-center pt-20">
        ...
        >
          <Image
            ...
            width={280}
            height={70}
            className="h-12 sm:h-14 md:h-16 w-auto object-contain mx-auto mb-10 opacity-90"
            priority
          />
        </motion.div>
        ...
        <motion.h1
          ...
          className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black text-white leading-[1.05] tracking-tight max-w-5xl mb-6"
        ...
        <motion.p
          ...
          className="text-lg sm:text-xl md:text-2xl text-white/40 font-light max-w-2xl mb-10 leading-relaxed"
        >
      ...
      >
        <div className="max-w-5xl mx-auto py-8 px-6 grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="text-center">
            ...
            <p className="text-[11px] text-white/25 uppercase tracking-[0.2em] mt-1.5 font-medium">micro-taches</p>
          </div>
          <div className="text-center">
            <AnimatedCounter end={25} prefix="" suffix="K€" />
            <p className="text-[11px] text-white/25 uppercase tracking-[0.2em] mt-1.5 font-medium">par film</p>
          </div>
          <div className="text-center">
            ...
            <p className="text-[11px] text-white/25 uppercase tracking-[0.2em] mt-1.5 font-medium">double ecosysteme</p>
          </div>
        </div>
      </motion.div>
