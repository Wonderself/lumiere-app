      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="hidden md:flex items-start relative">
          ...
          {pipelineSteps.map((step, idx) => (
            ...
            >
              {/* Dot */}
              <div className="relative z-10 mx-auto w-12 h-12 rounded-full border-2 border-[#D4AF37]/30 bg-[#0A0A0A] flex items-center justify-center mb-6">
    ...
    <section className="py-28 md:py-36 px-6 sm:px-10 md:px-16 lg:px-20">
      ...
      >
        ...
        <div className="grid grid-cols-4 bg-white/[0.02]">
          ...
          <div className="p-6 md:p-7 text-center border-l border-[#D4AF37]/10 bg-[#D4AF37]/[0.03]">
        ...
        {compRows.map((row, idx) => (
          <div key={row.label} className={`grid grid-cols-4 ${idx % 2 === 0 ? '' : 'bg-white/[0.01]'} border-t border-white/[0.04]`}>
            ...
            <div className="p-6 md:p-7 flex items-center justify-center border-l border-[#D4AF37]/10 bg-[#D4AF37]/[0.03]">
              {row.lumiere ? (
    ...
    <section className="py-28 md:py-36 px-6 sm:px-10 md:px-16 lg:px-20">
      ...
      >
        ...
        <div className="max-w-2xl mx-auto">
          <div className="h-[1px] w-16 bg-[#D4AF37]/30 mx-auto mb-12" />
          <motion.blockquote
            initial={{ opacity: 0 }}
