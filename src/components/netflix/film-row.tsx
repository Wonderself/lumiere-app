...
export function FilmRow({ title, films, href }: FilmRowProps) {
  ...
  return (
    <section className="relative group/row mb-12 md:mb-16">
      {/* Row title */}
      <div className="flex items-center justify-between px-8 md:px-16 lg:px-20 mb-5">
        <h2
      ...
      <div className="relative">
        ...
        <div
          ...
          className="flex gap-3 md:gap-4 overflow-x-auto scrollbar-hide px-8 md:px-16 lg:px-20 scroll-smooth"
          ...
          {films.map((film, idx) => (
            ...
            >
              ...
              <div className="pt-3 pb-1 px-0.5">
                <p className="text-[13px] font-semibold text-white/80 truncate group-hover/card:text-white transition-colors">{film.title}</p>
                {film.genre && (
                  <p className="text-[11px] text-white/30 mt-0.5">{film.genre}</p>
                )}
              </div>
            </Link>
          ))}
